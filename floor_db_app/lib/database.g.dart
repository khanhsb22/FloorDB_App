...
class _$PersonDao extends PersonDao {
  ...
  Future<List<Person>> getAllPeople() async {
    return _queryAdapter.queryList('SELECT * FROM Person',
        mapper: (Map<String, Object?> row) => Person(
            row['id'] as int?, row['name'] as String, row['age'] as String));
  }

  @override
  Future<void> deleteOnePerson(int id) async {
    await _queryAdapter
  ...
  @override
  Future<void> updatePerson(int id, String name, String age) async {
    await _queryAdapter.queryNoReturn(
        'UPDATE Person SET name = ?2, age = ?3 WHERE id = ?1',
